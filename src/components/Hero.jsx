      ...
      top-[120px] max-w-7xl mx-auto flex flex-row
       items-start gap-5`}>
        ...
        <div>
            ...
            <p className={`${styles.heroSubText} mt-2 text-white-100`}>We developes awesome web <br className='sm:block hidden'/>and mobile applications</p>
          </div>
       </div>
          <ComputersCanvas/>
          ...
          '>
            <a href='#about'>
              ...
              flex justify-center item-start p-2
              '>
                <motion.dev
                animate={{
                  y:[0,24,0]
